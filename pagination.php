<?php
	...
	if( is_search() ){
        ...
        if( $wp_rewrite->using_permalinks() ){
            ...
            $base = remove_query_arg( array( 'fp_template', 'fp_row', 'fp_element' ), $base );
			$pagination['base'] = user_trailingslashit( trailingslashit(  remove_query_arg( 'search', remove_query_arg( 's', $base ) ) ) . 'page/%#%/', 'paged' );
        }
