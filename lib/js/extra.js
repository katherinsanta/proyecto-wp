...
jQuery(document).ready(function () {
    /*if welcome message is closed, then we save a cookie to remember that*/
    jQuery('#hide-this .icon-close').click(function() {
        jQuery.cookie( "prikokewoo_styles" , 'closed' , {expires: 365, path: '/'});
    });
