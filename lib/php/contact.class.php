...
?>
            <form id="comment_form" class="form comments b_contact" method="post" action="<?php echo home_url() ?>/">
			  <fieldset>
				  <p class="input">
					  <input tabindex="1" type="text" onfocus="if (this.value == '<?php _e( 'Your name' , 'cosmotheme' ); ?> *') {this.value = '';}" onblur="if (this.value == '') {this.value = '<?php _e( 'Your name' , 'cosmotheme' ); ?> *';}" value="<?php _e( 'Your name' , 'cosmotheme' ); ?> *" name="name" id="name" />
				  </p>
				  <p class="input">
					  <input tabindex="2" type="text" onfocus="if (this.value == '<?php _e( 'Your email' , 'cosmotheme' ); ?> *') {this.value = '';}" onblur="if (this.value == '') {this.value = '<?php _e( 'Your email' , 'cosmotheme' ); ?> *';}" value="<?php _e( 'Your email' , 'cosmotheme' ); ?> *" name="email" id="email" />
				  </p>
				  <p class="textarea">
					  <textarea onfocus="if (this.value == '<?php _e( 'Message' , 'cosmotheme' ); ?> *') {this.value = '';}" onblur="if (this.value == '') {this.value = '<?php _e( 'Message' , 'cosmotheme' ); ?> *';}" tabindex="3" cols="50" rows="10" id="comment_widget" name="message"><?php _e( 'Message' , 'cosmotheme' ); ?> *</textarea>
				  </p>
				  <p class="button hover">
					  <input tabindex="4" type="button" value="<?php _e( 'Submit form' , 'cosmotheme' ); ?>" name="btn_send" onclick="javascript:act.send_mail( 'contact' , '#comment_form' , 'p#send_mail_result' );" class="inp_button" />
				  </p>
