<?php
    class resources{
        ...
        static function register(){
            if( !empty( self::$type ) ){
                ...
                if ( class_exists( 'WooCommerce' ) ) {
                    self::box( 'product' ); // add layout and shortcode boxes for products
                }
            }
        }
        ...
        static function gallery_builder(){
        ...
        static function gallery_shcode(){
            self::CallBox( 'gallery_shcode' );
        }
        ...
        /*===============BOF product boxes support==============*/
            static function addbox_product_shcode(){
                self::CallBox( 'addbox_product_shcode' );
            }
            static function addbox_product_settings(){
                self::CallBox( 'addbox_product_settings' );
            }
            static function addbox_product_builder(){
                self::CallBox( 'addbox_product_builder' );
            }

            static function product_shcode(){
                self::CallBox( 'product_shcode' );
            }

            static function product_settings(){
                self::CallBox( 'product_settings' );
            }
            static function product_builder(){
                self::CallBox( 'product_builder' );
            }
        
        /*===============EOF product boxes support==============*/
        ...
        /*static function gallery_location(){
            self::CallBox( 'gallery_location' );
        }

        static function gallery_news(){
            self::CallBox( 'gallery_news' );
        }*/
        ...
        static function gallery_layout(){
            self::CallBox( 'gallery_layout' );
        }
        ...
        static function gallery_format(){
            self::CallBox( 'gallery_format' );
        }

        static function gallery_source(){
            self::CallBox( 'gallery_source' );
        }
        ...
        static function addbox_gallery_imagesattached(){
            self::CallBox( 'addbox_gallery_imagesattached' );
        }

        static function gallery_imagesattached(){
            self::CallBox( 'gallery_imagesattached' );
        }
        ...
        static function addbox_gallery_builder(){
            self::CallBox( 'addbox_gallery_builder' );
        }

        static function addbox_gallery_shcode(){
            self::CallBox( 'addbox_gallery_shcode' );
        }
        ...
        static function addbox_gallery_location(){
            self::CallBox( 'addbox_gallery_location' );
        }

        static function addbox_gallery_news(){
            self::CallBox( 'addbox_gallery_news' );
        }
        
        static function addbox_gallery_layout(){
            self::CallBox( 'addbox_gallery_layout' );
        }
        ...
        static function addbox_gallery_format(){
            self::CallBox( 'addbox_gallery_format' );
        }

        static function addbox_gallery_source(){
            self::CallBox( 'addbox_gallery_source' );
        }
...
/*        function slideshow_manager(){
        ...
        function slideshow_slidesettings(){
        ...
        function addbox_slideshow_slidesettings(){
