<?php
    class widget_comments extends WP_Widget {
        ...
        function widget_comments() {
            ...
            parent::__construct( 'widget_cosmo_comments' , _TN_ . ' : ' . __( 'Comments' , 'cosmotheme' ) , $widget_ops );
        }
                                ...
                                <article class="row">
                                    <div class="four mobile-one columns">
                                        <a class="entry-img" href="<?php echo get_permalink( $comment -> comment_post_ID ) . '#comment-' . $comment -> comment_ID; ?>">
                                            <?php $size = image::asize( 'thumbnail' ); echo cosmo_avatar( $comment, $size[0] , DEFAULT_AVATAR );  ?>
                                        </a>
                                    </div>
