...
class widget_category_icons extends WP_Widget {
	...
	/*Constructor*/
		...
		parent::__construct( 'widget_cosmo_category_icons', _TN_ . ' : ' . __( 'Category icons' , 'cosmotheme' ) , $widget_ops );
	}

    /**
     * Legacy constructor for back-compat with plugins that extended this widget.
     */
