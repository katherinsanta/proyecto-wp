<?php
    class widget_tabber extends WP_Widget {
        ...
        function widget_tabber() {
            ...
            parent::__construct( 'widget_cosmo_tabber' , _TN_ . ' : ' . __( 'Tabber' , 'cosmotheme' ) , $widget_ops );
        }
                                    ...
                                    <article class="row">
                                        <div class="four mobile-one columns">
                                            <a class="entry-img" href="<?php echo get_permalink( $comment -> comment_post_ID ) . '#comment-' . $comment -> comment_ID; ?>">
                                                <?php $size = image::asize( 'thumbnail' ); echo cosmo_avatar( $comment -> user_id , $size[0] , DEFAULT_AVATAR );  ?>
                                            </a>
                                        </div>
