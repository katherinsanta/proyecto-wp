...
class widget_instagram extends WP_Widget {
	...
	function update( $new_instance, $old_instance ) {
		...
		//update setting with information from widget form
		...
		$instance['link_images'] = isset( $new_instance['link_images'] ) ? strip_tags($new_instance['link_images']) : '';
		
		$instance['show_likes'] = isset( $new_instance['show_likes'] ) ? strip_tags($new_instance['show_likes']) : '';
		$instance['show_caption'] = isset( $new_instance['show_caption'] ) ? strip_tags($new_instance['show_caption']) : '';
		
		$instance['debug_mode'] = isset( $new_instance['debug_mode'] ) ? strip_tags($new_instance['debug_mode']) : '';
	...
	function get_recent_data($user_id, $access_token){
		...
		$response = wp_remote_get( $apiurl, array('sslverify' => false, 'timeout' => 10) );
