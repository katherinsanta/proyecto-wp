<?php
    ...
    if ( class_exists( 'WooCommerce' ) ) {
        add_action('wp_ajax_add_to_wishlist' , array( 'post' , 'add_to_wishlist' ) );
        add_action('wp_ajax_nopriv_add_to_wishlist' , array( 'post' , 'add_to_wishlist' ) );

        add_action('wp_ajax_remove_from_wishlist' , array( 'post' , 'remove_from_wishlist' ) );
        add_action('wp_ajax_nopriv_remove_from_wishlist' , array( 'post' , 'remove_from_wishlist' ) );
    }
