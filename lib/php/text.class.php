<?php
	class text{
		...
		static function fields( $page , $prefix , $classes = '' , $text = 'Test text for preview' , $default = array( 'Francois+One&v1' , 24 , 'normal' ), $show_font_weight = true, $show_font_size = true ){
			if(strlen($default[0])){
