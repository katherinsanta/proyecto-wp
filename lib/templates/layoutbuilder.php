...
<div id="the-closet" style="display: none;">
    ...
    <div class="select-box galleries">
        <div class="search-holder">
            <input class="search">
            <a href="javascript:void(0);" class="clear-input" title="<?php echo __( 'Clear input' , 'cosmotheme' );?>"></a>
        </div>
    ...
    <div class="select-box pages">
     ...
     <div class="select-box galeries">
        <div class="search-holder">
            <input type="hidden" name="" class="generic-record generic-value" value="" />
            <input type="hidden" class="generic-params" value="%7B%22post_type%22%3A%gallery%22%2C%22post_status%22%3A%22publish%22%7D" />
