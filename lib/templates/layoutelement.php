...
endhtml
    ...
    <div class="element-container">
        <?php
            ...
            $this -> print_taxonomy_inputs( 'galleries', $this -> galleries );
        ...
        <div class="select-box galeries hidden">
            <input type="radio" name="<?php echo $this -> get_prefix();?>[galleryID]" value="<?php echo $this -> galleryID;?>" checked="checked">
        </div>
    ...
    <div class="standard-generic-field generic-field-front_page">
        <div class="generic-label">
            <label>
                <?php echo __( 'Label description' , 'cosmotheme' );?>
            </label>
        </div>
        <div class="generic-field generic-field-input">
            <input name="<?php echo $this -> get_prefix();?>[label_description]" class="element-description" value="<?php echo $this -> label_description;?>">
        </div>
        <div class="clear"></div>
    </div>
    ...
    <div class="standard-generic-field generic-field-header">
        ...
        <div class="generic-field generic-field-image-select element-type">
            ...
            <label>
                <?php echo __( 'Gallery Categories' , 'cosmotheme' );?>
                <input type="radio" value="gallery_categories" name="<?php echo $this -> get_prefix();?>[type]" class="gallery-type" <?php checked( $this -> type, 'gallery_categories' );?>>
            </label>
            <label>
            ...
            <label>
                <?php echo __( 'Latest galeries' , 'cosmotheme' );?>
                <input type="radio" value="latest_galleries" name="<?php echo $this -> get_prefix();?>[type]" <?php checked( $this -> type, 'latest_galleries' );?>>
            </label>
            <?php 
                /* BOF check if woocommerce is installed*/
                if ( class_exists( 'WooCommerce' ) ) {
            ?>

                <label>
                    <?php echo __( 'Latest products' , 'cosmotheme' );?>
                    <input type="radio" value="latest_products" name="<?php echo $this -> get_prefix();?>[type]" <?php checked( $this -> type, 'latest_products' );?>>
                </label>
                <label>
                    <?php echo __( 'Featured products' , 'cosmotheme' );?>
                    <input type="radio" value="featured_products" name="<?php echo $this -> get_prefix();?>[type]" <?php checked( $this -> type, 'featured_products' );?>>
                </label>
                <label>
                    <?php echo __( 'Products on sale' , 'cosmotheme' );?>
                    <input type="radio" value="on_sale_products" name="<?php echo $this -> get_prefix();?>[type]" <?php checked( $this -> type, 'on_sale_products' );?>>
                </label>
                <label title="<?php _e('If this element will be used on the front page, make sure you select a Static page from Settings -> Reading, then assign \'Shop\' page for front Page, otherwise it will display you the latest posts.','cosmotheme') ?>">
                    <?php echo __( 'Woo Shop' , 'cosmotheme' );?>
                    <input type="radio" value="woo_shop" name="<?php echo $this -> get_prefix();?>[type]" <?php checked( $this -> type, 'woo_shop' );?>>
                </label>
                <label>
                    <?php echo __( 'Best sellers (products)' , 'cosmotheme' );?>
                    <input type="radio" value="best_sellers_products" name="<?php echo $this -> get_prefix();?>[type]" <?php checked( $this -> type, 'best_sellers_products' );?>>
                </label>

            <?php 
                /* EOF check if woocommerce is installed*/
                }
            ?>
            <label>
                <?php echo __( 'Page' , 'cosmotheme' );?>
                <input  class="page-type" type="radio" value="page" name="<?php echo $this -> get_prefix();?>[type]" <?php checked( $this -> type, 'page' );?>>
            </label>
            <label>
                <?php echo __( 'Post' , 'cosmotheme' );?>
                <input class="post-type" type="radio" value="post" name="<?php echo $this -> get_prefix();?>[type]" <?php checked( $this -> type, 'post' );?>>
            </label>
            <label title="<?php _e('If this option is selected all other rows and footer content will not work. Only the gallery will show up on the screen.','cosmotheme') ?>">
                <?php echo __( 'Gallery' , 'cosmotheme' );?>
                <input  class="gallery-post-type" type="radio" value="gallery" name="<?php echo $this -> get_prefix();?>[type]" <?php checked( $this -> type, 'gallery' );?>>
            </label>
            <label>
    ...
    <div class="standard-generic-field generic-field-header options-view-type">
        ...
        <div class="generic-field generic-field-image-select element-view-type">
            ...
            <label>
                <?php echo __( 'Mosaic', 'cosmotheme' );?>
                <input class="mosaic_view" type="radio" value="mosaic_view" name="<?php echo $this -> get_prefix();?>[view]" <?php checked( $this -> view, 'mosaic_view' );?>>
            </label>
<!--             <label>
    ...
    <div class="standard-generic-field generic-field-header option-list-thumb-size">
        ...
        <div class="generic-field generic-field-image-select">
            ...
            <label>
                ...
                <input type="radio" value="medium_width_thumb" name="<?php echo $this -> get_prefix();?>[list_view_thumb_size]" <?php checked( $this -> list_view_thumb_size, 'medium_width_thumb' );?>>
            </label>
            <label>
